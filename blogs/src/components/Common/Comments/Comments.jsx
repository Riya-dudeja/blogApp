...
const Comments = ({postId}) => {
  ...
  return (
    <Modal modal={showComment} setShowModal={setShowComment}>
      <section
        className={`
          fixed top-0 right-0 bottom-0 z-50 bg-white w-[22rem] shadows p-5 overflow-y-auto transition-all duration-500 ${showComment ? "translate-x-0" : "translate-x-[23rem]"}
      `}>
        {/* header */}
